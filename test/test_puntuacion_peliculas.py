...
class TestGestorResena(unittest.TestCase):
    def setUp(self):
        ...
        self.reseña_valida = Resena(1, "Película de Prueba", 2023, 4, "Buena película")
        self.reseña_existente = Resena(1, "Película de Prueba", 2023, 3, "Interesante")
    ...
    def test_agregar_resena_no_identificado(self):
        ...
        with self.assertRaises(ValueError) as cm:
            self.gestor_resena.agregar_resena(Resena(None, "Película", 2023, 5, "Buena"))
    ...
    def test_agregar_resena_pelicula_inexistente(self):
        ...
        resultado = self.gestor_resena.agregar_resena(
            Resena(1, "Película Inexistente", 2024, 5, "Excelente")
        )
    ...
    def test_agregar_resena_sin_puntuacion(self):
        ...
        with self.assertRaises(ValueError) as cm:
            self.gestor_resena.agregar_resena(Resena(1, "Película", 2023, None, "Buenísima"))
    ...
    def test_agregar_resena_sin_comentario(self):
        ...
        with self.assertRaises(ValueError) as cm:
            self.gestor_resena.agregar_resena(Resena(1, "Película", 2023, 5, ""))
    ...
    def test_modificar_resena(self):
        ...
        resultado = self.gestor_resena.modificar_resena(1, "Película de Prueba", 2023, 5, "Excelente")
        self.assertTrue(resultado)

    def test_modificar_resena_no_modificada(self):
        """La reseña no ha sido modificada respecto a la reseña anterior."""
        resultado = self.gestor_resena.modificar_resena(1, "Película de Prueba", 2023, 3, "Interesante")
        self.assertFalse(resultado)
    ...
    def test_modificar_resena_no_autorizada(self):
        ...
        resultado = self.gestor_resena.modificar_resena(2, "Película de Prueba", 2023, 5, "Buenísima")
        self.assertFalse(resultado)
